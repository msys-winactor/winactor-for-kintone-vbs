...
Sub KNTN_AddRecords()
  ...
  call Kntn_getHeaderArray(json_fieldsInfo,"レコード登録用フィールド取得（ヘッダーのみ）",nameOrCode,RootArray_AddApiFields,excelSheetName,lookUpArray,False)
  array_header = RootArray_AddApiFields.item(excelSheetName)
